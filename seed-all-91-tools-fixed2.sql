...
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'chat' AND status = 'published') WHERE slug = 'chat';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'writing' AND status = 'published') WHERE slug = 'writing';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'image' AND status = 'published') WHERE slug = 'image';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'video' AND status = 'published') WHERE slug = 'video';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'code' AND status = 'published') WHERE slug = 'code';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'audio' AND status = 'published') WHERE slug = 'audio';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'productivity' AND status = 'published') WHERE slug = 'productivity';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'design' AND status = 'published') WHERE slug = 'design';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'research' AND status = 'published') WHERE slug = 'research';
UPDATE categories SET tool_count = (SELECT COUNT(*) FROM tools WHERE category = 'marketing' AND status = 'published') WHERE slug = 'marketing';
